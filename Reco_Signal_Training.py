...
tol=1.e-3, verbose=True, max_iter=100)

pickle_classification = 'classification_V3_9_n1500_M80_AE_Signal_20160928_154159.pkl'
...
# Save pickle model
save_pickle('clf_' + str(filename1[:-4]) + '.pkl', clf)
...
info = [filename1, config_analysis, config_filter, config_demod, config_diff, len(classification), classification]
print(info)
...
pik_filename = 'info.pkl'
pik = open(pik_filename, 'wb')
pickle.dump(info, pik)
pik.close()
