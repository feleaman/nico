...
def main(argv):
	...
	ax[0].set_xlabel('Frequency [Hz]', fontsize=13)	
	...
	# ax[1].set_ylabel('Amplitude [mV]', fontsize=13)
	# ax[2].set_ylabel('Amplitude [mV]', fontsize=13)
...
def invoke_signal(config):
	...
	config_demod = {'analysis':False, 'mode':'hilbert', 'prefilter':['bandpass', [95.e3, 140.e3], 3],
	...
	for filepath in Filepaths:
		...
		analysis_dict = {'wfm':x, 'fft':magX, 'f':f, 'filename':filename}
